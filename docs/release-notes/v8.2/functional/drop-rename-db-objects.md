...
![01 TableProcesses](pathname:///img/release-notes/v8.2/01_TableProcesses.png)
...
![02 RenameTable](pathname:///img/release-notes/v8.2/02_RenameTable.png)

At the end it shows the SQL statements executed to rename the table and the associated columns.

![03 RenameTableResult](pathname:///img/release-notes/v8.2/03_RenameTableResult.png)
...
![04 DropTable](pathname:///img/release-notes/v8.2/04_DropTable.png)

## New Processes in Column tab
![05 ColumnProcesses](pathname:///img/release-notes/v8.2/05_ColumnProcesses.png)
...
![06 DropColumn](pathname:///img/release-notes/v8.2/06_DropColumn.png)

## Drop Constraint
This process allows to drop a constraint in the database.

![07 DropConstraint](pathname:///img/release-notes/v8.2/07_DropConstraint.png)

## New Process in Element tab
![08 ElementProcess](pathname:///img/release-notes/v8.2/08_ElementProcess.png)
...
![09 RenameColumns](pathname:///img/release-notes/v8.2/09_RenameColumns.png)

At the end it shows the SQL statements executed to rename all the columns found in the different tables.

![10 RenameColumnsResult](pathname:///img/release-notes/v8.2/10_RenameColumnsResult.png)
