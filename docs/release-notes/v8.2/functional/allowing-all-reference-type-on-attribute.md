---
id: allowing-all-reference-type-on-attribute
...
![Attribute Table Reference](pathname:///img/release-notes/v8.2/Attribute-Table-Reference.PNG)
...
![Attribute Reference Type](pathname:///img/release-notes/v8.2/Attribute-Reference_Type.PNG)

Below is how attribute dialog looks with different editor.

![Attribute Panel](pathname:///img/release-notes/v8.2/Attribute-Panel.PNG)
