---
id: create-window-tab-field-from-table
...
**Video tutorial:** <YouTube id="qz5QOBhKGf4" title="YouTube" />
...
![CreateWindowFromTableProcess](pathname:///img/release-notes/v8.2/CreateWindowFromTableProcess.jpg)

2. On the process window, fill the parameters.

![CreateWindowProcessMenu](pathname:///img/release-notes/v8.2/CreateWindowProcessMenu.jpg)
