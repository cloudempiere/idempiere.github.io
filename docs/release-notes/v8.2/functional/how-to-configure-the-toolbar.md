---
id: how-to-configure-the-toolbar
...
![OldToolbar](pathname:///img/release-notes/v8.2/OldToolbar.jpg)

To this:

![NewToolbar8.2](pathname:///img/release-notes/v8.2/NewToolbar8.2.jpg)
...
![FontSysConfig](pathname:///img/release-notes/v8.2/FontSysConfig.jpg)

2. The order in which the toolbar buttons are displayed in the window can be changed in the Toolbar Button window.

![ToolbarWindow](pathname:///img/release-notes/v8.2/ToolbarWindow.jpg)
...
![ToolbarButton](pathname:///img/release-notes/v8.2/ToolbarButton.gif)

Group buttons in the toolbar
![GroupMoreToolbar](pathname:///img/release-notes/v8.2/GroupMoreToolbar.gif)
