---
id: inject-context-variables-from-menu
...
![01 Inject From Menu](pathname:///img/release-notes/v8.2/01_Inject_From_Menu.png)
...
![02 Inject From Window](pathname:///img/release-notes/v8.2/02_Inject_From_Window.png)
