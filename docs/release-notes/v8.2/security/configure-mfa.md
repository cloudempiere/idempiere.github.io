...
![00 MFAMenu](pathname:///img/release-notes/v8.2/00_MFAMenu.png)
...
![01 MFAMethod](pathname:///img/release-notes/v8.2/01_MFAMethod.png)
...
![02 MFARule](pathname:///img/release-notes/v8.2/02_MFARule.png)
...
![03 MFARegister](pathname:///img/release-notes/v8.2/03_MFARegister.png)
...
![04 MFATOTPForm](pathname:///img/release-notes/v8.2/04_MFATOTPForm.png)

The screen for EMail is similar, but slightly different:

![05 MFAEMailForm](pathname:///img/release-notes/v8.2/05_MFAEMailForm.png)
...
![06 MFACompleteReg](pathname:///img/release-notes/v8.2/06_MFACompleteReg.png)
...
![07 MFALogin](pathname:///img/release-notes/v8.2/07_MFALogin.png)
