---
id: implement-oauth2-for-email-authentication
...
![00 AuthorizationMenu](pathname:///img/release-notes/v8.2/00_AuthorizationMenu.png)
...
![01 AuthorizationProvider](pathname:///img/release-notes/v8.2/01_AuthorizationProvider.png)
...
![02 ScopeAuthorizationProvider](pathname:///img/release-notes/v8.2/02_ScopeAuthorizationProvider.png)
...
- Specify who can use the application (Supported account types)
    ...
    - To correct "tenant", you can check endpoints info of app![End point](pathname:///img/release-notes/v8.2/End_point.png)
...
![03 Credential](pathname:///img/release-notes/v8.2/03_Credential.png)
...
![04 AddMailAccount](pathname:///img/release-notes/v8.2/04_AddMailAccount.png)
...
![04 AddMailAccount2](pathname:///img/release-notes/v8.2/04_AddMailAccount2.png)

After this a new browser window is opened showing your provider login page

![04A GoogleAuth](pathname:///img/release-notes/v8.2/04A_GoogleAuth.png)

You must login into google as usual and then you are presented with the authorization page

![04C Authorization](pathname:///img/release-notes/v8.2/04C_Authorization.png)
...
![04D Authorized](pathname:///img/release-notes/v8.2/04D_Authorized.png)

## Account
After authorized, a record is created in the *Authorization Account* tab:

![05 Account](pathname:///img/release-notes/v8.2/05_Account.png)
...
![04 DoNotOpenPopup](pathname:///img/release-notes/v8.2/04_DoNotOpenPopup.png)

After executed in this way the output looks like this:

![04 ManualAuth](pathname:///img/release-notes/v8.2/04_ManualAuth.png)
...
![04A ManualAuthAnswer](pathname:///img/release-notes/v8.2/04A_ManualAuthAnswer.png)
