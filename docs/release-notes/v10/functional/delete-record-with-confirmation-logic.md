---
id: delete-record-with-confirmation-logic
...
![Deleteconfirm logic value](pathname:///img/release-notes/v10/Deleteconfirm-logic-value.png)
![Deleteconfirm logic value invalidanswer](pathname:///img/release-notes/v10/Deleteconfirm-logic-value-invalidanswer.png)

##### **Single Record ask Date**
![Deleteconfirm logic date](pathname:///img/release-notes/v10/Deleteconfirm-logic-date.png)
![Deleteconfirm logic date input](pathname:///img/release-notes/v10/Deleteconfirm-logic-date-input.png)

##### **Multiple Records selection**
![Deleteconfirm mulitple records](pathname:///img/release-notes/v10/Deleteconfirm-mulitple-records.png)

##### **Window Customisation**
![Deleteconfirm logic windowcustomisation](pathname:///img/release-notes/v10/Deleteconfirm-logic-windowcustomisation.png)

##### **Translation: Spain Translation of Delete**
![Deleteconfirm logic translation](pathname:///img/release-notes/v10/Deleteconfirm-logic-translation.png)
