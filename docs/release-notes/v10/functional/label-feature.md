...
![ToolbarIcon](pathname:///img/release-notes/v10/ToolbarIcon.png)
...
![SystemConfigurator](pathname:///img/release-notes/v10/SystemConfigurator.png)

Labels can be translated, have a category assigned and have a CSS style applied to them:

![LabelWindow](pathname:///img/release-notes/v10/LabelWindow.png)
...
![LabelCategoryWindow](pathname:///img/release-notes/v10/LabelCategoryWindow.png)
...
![LabelAssignmentWindow](pathname:///img/release-notes/v10/LabelAssignmentWindow.png)
