---
id: ask-for-secret-input-within-process
...
![SecretInputGif](pathname:///img/release-notes/v10/SecretInputGif.gif)
...
![Secret input dialog within a process](pathname:///img/release-notes/v10/Secret_input_dialog_within_a_process.jpg)
