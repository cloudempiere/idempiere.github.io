---
id: add-customer-account-freightcostrule
...
![5083 FreightCostRule](pathname:///img/release-notes/v10/5083_FreightCostRule.png)
...
![5083 BPShippingAccount](pathname:///img/release-notes/v10/5083_BPShippingAccount.png)

_Business Partner Shipping Account_
:* Sales Order Freight Cost Rule
![5083 SalesOrderFreightCostRule](pathname:///img/release-notes/v10/5083_SalesOrderFreightCostRule.png)

_Sales Order Freight Cost Rule_
:* Customer Shipment Default
![5083 CustomerShipment](pathname:///img/release-notes/v10/5083_CustomerShipment.png)
