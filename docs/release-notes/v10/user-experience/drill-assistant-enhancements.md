---
id: drill-assistant-enhancements
...
![Drill rule window procparameter](pathname:///img/release-notes/v10/Drill-rule-window-procparameter.png)
...
![Drill rule window procparameter capture](pathname:///img/release-notes/v10/Drill-rule-window-procparameter-capture.png)
time saver, propose parameters to be defined.

### STEP 3 -  Drill Rule - capture - enter parameters
![Drill rule window procparameter capture para](pathname:///img/release-notes/v10/Drill-rule-window-procparameter-capture-para.png)
...
![Drill start](pathname:///img/release-notes/v10/Drill-start.png)

### STEP 5 -  Drill Assistant in Action
Drilling supported from report and windows

#### Step 5b Drill from Report
Drill Rule allow run report with without help option - running silent, with predefined parameter.![Drill assistant opened](pathname:///img/release-notes/v10/Drill-assistant-opened.png)
...
![Drillassistant with help](pathname:///img/release-notes/v10/Drillassistant-with-help.png)

#### Drill from Window
Drill Rule allow also run report from window table, table direct and search references.
![Drill from window](pathname:///img/release-notes/v10/Drill-from-window.gif)

_allow drilling from window_

### STEP 6 -  Drill Assistant Run, and the new report rendered
![Drill action runreport](pathname:///img/release-notes/v10/Drill-action-runreport.png)
