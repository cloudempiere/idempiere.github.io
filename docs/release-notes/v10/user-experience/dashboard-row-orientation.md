...
![Dashboard row concept](pathname:///img/release-notes/v10/Dashboard-row-concept.png)
...
![Dashboard row 1 3 1](pathname:///img/release-notes/v10/Dashboard-row-1-3-1.png)
![Row orientation example](pathname:///img/release-notes/v10/Row-orientation_example.png)
