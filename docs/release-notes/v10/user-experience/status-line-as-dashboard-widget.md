---
id: status-line-as-dashboard-widget
...
![Select existing status line](pathname:///img/release-notes/v10/Select_existing_status_line.png)
...
![Kpi widget by status line](pathname:///img/release-notes/v10/Kpi_widget_by_status_line.png)
...
**The result**
![Kpi status line trick](pathname:///img/release-notes/v10/Kpi-status-line-trick.png)
