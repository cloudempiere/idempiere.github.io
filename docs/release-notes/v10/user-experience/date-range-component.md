...
![Screencast for date range picker](pathname:///img/release-notes/v10/Screencast_for_date_range_picker.gif)
...
![Window range](pathname:///img/release-notes/v10/Window-range.gif)
...
![Infowindow daterange](pathname:///img/release-notes/v10/Infowindow-daterange.gif)
...
![Date range current](pathname:///img/release-notes/v10/Date-range-current.png)
...
![Date range previous](pathname:///img/release-notes/v10/Date-range-previous.png)
...
![Date range next](pathname:///img/release-notes/v10/Date-range-next.png)

_Illustrates, how the user able to select future period_

**Before**  a specific date

![Date range before](pathname:///img/release-notes/v10/Date-range-before.png)

_Illustrates, how the user able to select a period before selected date._

**After**  a specific date

![Date range after](pathname:///img/release-notes/v10/Date-range-after.png)

_Illustrates, how the user able to select a period after selected date._

**ON**  exact date

![Date range on](pathname:///img/release-notes/v10/Date-range-on.png)

_Illustrates, how the user able to select a period On selected date._
![Date range quickmode](pathname:///img/release-notes/v10/Date-range-quickmode.png)

_Illustrates specific layout for selecting various periods quickly._

**Between**  two dates

![Date range between](pathname:///img/release-notes/v10/Date-range-between.png)
...
![DatePickerAgo](pathname:///img/release-notes/v10/DatePickerAgo.png)
