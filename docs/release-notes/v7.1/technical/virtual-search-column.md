...
![SQLFINDCOLUMN](pathname:///img/release-notes/v7.1/SQLFINDCOLUMN.jpg)

The users will be able to search through that column in simple and advanced searches

![SQVIRTUALNORMAL](pathname:///img/release-notes/v7.1/SQVIRTUALNORMAL.jpg)

![SQLFINDAVANCED](pathname:///img/release-notes/v7.1/SQLFINDAVANCED.jpg)
