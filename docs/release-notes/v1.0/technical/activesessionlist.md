...
![Active session List](pathname:///img/release-notes/v1.0/Active_session_List.png)
...
![Look up snap](pathname:///img/release-notes/v1.0/Look_up-snap.jpg)
...
![killSession menu](pathname:///img/release-notes/v1.0/killSession_menu.png)

- System administrator can set the timeout value before killing the session.

![killSession popup](pathname:///img/release-notes/v1.0/killSession_popup.png)
...
![killsession timeout panel](pathname:///img/release-notes/v1.0/killsession_timeout_panel.png)
