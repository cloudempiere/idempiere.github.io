...
![First Look](pathname:///img/release-notes/v1.0/First_Look.png)
...
![Web Service Parameters](pathname:///img/release-notes/v1.0/Web_Service_Parameters.png)
...
![WebService Field Input](pathname:///img/release-notes/v1.0/WebService_Field_Input.png)

### DB Column Name
![WebService Field Input CtxVariable](pathname:///img/release-notes/v1.0/WebService_Field_Input_CtxVariable.png)
...
![WebService Field Input IdentifierLogic](pathname:///img/release-notes/v1.0/WebService_Field_Input_IdentifierLogic.png)
...
![Web Service Field Output](pathname:///img/release-notes/v1.0/Web_Service_Field_Output.png)
...
![Web Service Access](pathname:///img/release-notes/v1.0/Web_Service_Access.png)
...
<YouTube id="GrIhWbPQBrs" /> by Jan.thielemann - [evenos Consulting GmbH](http://evenos-consulting.de)
...
![CtxVariable](pathname:///img/release-notes/v1.0/CtxVariable.png)
...
![Reference OverRiding](pathname:///img/release-notes/v1.0/Reference_OverRiding.png)
