...
New Window Schedule
![scheduler1](pathname:///img/release-notes/v1.0/scheduler1.png)
...
![scheduler3](pathname:///img/release-notes/v1.0/scheduler3.png)

On Scheduler window a new field Schedule was added to choose  the schedule to that process.

![scheduler2](pathname:///img/release-notes/v1.0/scheduler2.png)
