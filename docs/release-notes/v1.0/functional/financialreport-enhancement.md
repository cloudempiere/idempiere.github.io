---
status: approved
id: financial-report-enhancement
...
![NF001 FinancialReport ListSourcesXTrx](pathname:///img/release-notes/v1.0/NF001_FinancialReport_ListSourcesXTrx.png)
...
![NF001 ListSourcesXTrx Sample](pathname:///img/release-notes/v1.0/NF001_ListSourcesXTrx_Sample.png)

## Percentage for column value against calculated line value
### Single Line Value
![NF001 ReportColumn PercentageOfLine Single](pathname:///img/release-notes/v1.0/NF001_ReportColumn_PercentageOfLine_Single.png)
...
![NF001 Single Percentage Sample](pathname:///img/release-notes/v1.0/NF001_Single_Percentage_Sample.png)

### Multiple Line Value
![NF001 ReportColumn PercentageOfLine Multi](pathname:///img/release-notes/v1.0/NF001_ReportColumn_PercentageOfLine_Multi.png)
...
![NF001 Multi Percentage Example](pathname:///img/release-notes/v1.0/NF001_Multi_Percentage_Example.png)
