...
![inventory1](pathname:///img/release-notes/v1.0/inventory1.png)

![inventory2](pathname:///img/release-notes/v1.0/inventory2.png)

## New document types created
- Internal Use Inventory

![inventory3](pathname:///img/release-notes/v1.0/inventory3.png)

- Material Physical Inventory

![inventory4](pathname:///img/release-notes/v1.0/inventory4.png)
