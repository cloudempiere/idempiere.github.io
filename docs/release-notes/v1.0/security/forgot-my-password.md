...
![Screenshot5](pathname:///img/release-notes/v1.0/Screenshot5.png)

It is also necessary to think about setting the smtp at the SYSTEM client level
![Client SMTP](pathname:///img/release-notes/v1.0/Client_SMTP.png)

The link "Forgot My Password" is showing in login dialog

![Screenshot6](pathname:///img/release-notes/v1.0/Screenshot6.png)
...
![Screenshot7](pathname:///img/release-notes/v1.0/Screenshot7.png) ![Screenshot8](pathname:///img/release-notes/v1.0/Screenshot8.png)
...
![Screenshot11](pathname:///img/release-notes/v1.0/Screenshot11.png)
...
![Screenshot12](pathname:///img/release-notes/v1.0/Screenshot12.png)
