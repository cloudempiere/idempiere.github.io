---
status: approved
id: restrict-toolbar-buttons
title: "Restrict Toolbar Buttons"
sidebar_label: "Restrict Toolbar Buttons"
description: "**Goal:** Security / Usability"
tags: [v1.0, security]
---
...
**Sponsor of additional work:** [Trek Global](/docs/sponsors/Trek_Global)
...
![NF001 ToolbarButtonRestrict001](pathname:///img/release-notes/v1.0/NF001_ToolbarButtonRestrict001.png)

**Restrict Delete button in ALL windows for GardenUser role**

![NF001 ToolbarButtonRestrict002](pathname:///img/release-notes/v1.0/NF001_ToolbarButtonRestrict002.png)

**Restrict DeleteSelection button in Product windows for GardenAdmin role**

![NF001 ToolbarButtonRestrict003](pathname:///img/release-notes/v1.0/NF001_ToolbarButtonRestrict003.png)

**Restrict Email button for report viewer launch from Business Partner windows for GardenUser role**

![NF001 ToolbarButtonRestrict004](pathname:///img/release-notes/v1.0/NF001_ToolbarButtonRestrict004.png)

**Restrict Archive button for all report for GardenUser role**

![NF001 ToolbarButtonRestrict005](pathname:///img/release-notes/v1.0/NF001_ToolbarButtonRestrict005.png)

**Restrict Copy Sales Order Line button for sales order window for GardenUser role**

![NF001 ToolbarButtonRestrict006](pathname:///img/release-notes/v1.0/NF001_ToolbarButtonRestrict006.png)
