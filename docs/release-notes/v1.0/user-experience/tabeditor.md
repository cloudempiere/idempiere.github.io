...
**Movie Demo:** <YouTube id="3vOmZ0o09KY" title="YouTube" />

## Editing Sales Order Header Tab
*Window, Tab Field* -> *Sales Order Header Tab* -> *New tool bar button!*

![TabEditorButton](pathname:///img/release-notes/v1.0/TabEditorButton.png)
...
![TabEditor](pathname:///img/release-notes/v1.0/TabEditor.png)
...
![TabEditorEdited](pathname:///img/release-notes/v1.0/TabEditorEdited.png)
