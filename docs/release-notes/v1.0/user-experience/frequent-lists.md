...
status: approved
id: frequent-lists
title: "Frequent lists"
sidebar_label: "Frequent lists"
...
![01 AddShortListToPaymentTerm](pathname:///img/release-notes/v1.0/01_AddShortListToPaymentTerm.png)

## Behaviour
Define the records that you want to appear in the short list:

![02 DefinePaymentTermShortList](pathname:///img/release-notes/v1.0/02_DefinePaymentTermShortList.png)

And then the users will see initially just the short list:

![03 PaymentTermShortList](pathname:///img/release-notes/v1.0/03_PaymentTermShortList.png)

To enable the full list user just needs to right-click and toggle to full list:

![04 ToggleShortList](pathname:///img/release-notes/v1.0/04_ToggleShortList.png)
