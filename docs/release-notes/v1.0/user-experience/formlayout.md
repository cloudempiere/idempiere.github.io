...
![NF001 FormLayout001](pathname:///img/release-notes/v1.0/NF001_FormLayout001.png)

For example the business partner layout can be configured this way:

![NF001 FormLayout002](pathname:///img/release-notes/v1.0/NF001_FormLayout002.png)

To achieve this result:

![NF001 FormLayout003](pathname:///img/release-notes/v1.0/NF001_FormLayout003.png)
