...
![User password hash algorithm](pathname:///img/release-notes/v12/User_password_hash_algorithm.png)

_USER_PASSWORD_HASH_ALGORITHM_

2. Added **Password Hash Algorithm** parameter to the **Convert passwords to hashes** process.
![Convert passwords to hash](pathname:///img/release-notes/v12/Convert_passwords_to_hash.png)
