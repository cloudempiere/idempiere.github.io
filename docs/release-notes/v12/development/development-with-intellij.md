...
![Import com.trekglobal.idempiere.rest.api Step 1](pathname:///img/release-notes/v12/Import_com.trekglobal.idempiere.rest.api_Step_1.png)

_Import com.trekglobal.idempiere.rest.api - Step 1_
- Step 2

![Import com.trekglobal.idempiere.rest.api Step 2](pathname:///img/release-notes/v12/Import_com.trekglobal.idempiere.rest.api_Step_2.png)

_Import com.trekglobal.idempiere.rest.api - Step 2_
- Step 3

![Import com.trekglobal.idempiere.rest.api Step 3](pathname:///img/release-notes/v12/Import_com.trekglobal.idempiere.rest.api_Step_3.png)

_Import com.trekglobal.idempiere.rest.api - Step 3_
- Step 4

![Import com.trekglobal.idempiere.rest.api Step 4](pathname:///img/release-notes/v12/Import_com.trekglobal.idempiere.rest.api_Step_4.png)

_Import com.trekglobal.idempiere.rest.api - Step 4_
- Step 5

![Import com.trekglobal.idempiere.rest.api Step 5](pathname:///img/release-notes/v12/Import_com.trekglobal.idempiere.rest.api_Step_5.png)

_Import com.trekglobal.idempiere.rest.api - Step 5_
- Step 6

![Import com.trekglobal.idempiere.rest.api Step 6](pathname:///img/release-notes/v12/Import_com.trekglobal.idempiere.rest.api_Step_6.png)
...
![Exclude Rest API Module Target Folder](pathname:///img/release-notes/v12/Exclude_Rest_API_Module_Target_Folder.png)

_Exclude com.trekglobal.idempiere.rest.api target folder_
- Set Compile Output Path

![Com.trekglobal.idempiere.rest.api compile output path](pathname:///img/release-notes/v12/Com.trekglobal.idempiere.rest.api_compile_output_path.png)

_Compile output path of com.trekglobal.idempiere.rest.api_
- Set Eclipse PDE Partial Settings

![Com.trekglobal.idempiere.rest.api facet output path](pathname:///img/release-notes/v12/Com.trekglobal.idempiere.rest.api_facet_output_path.png)
...
![Com.trekglobal.idempiere.rest.api Module Dependencies](pathname:///img/release-notes/v12/Com.trekglobal.idempiere.rest.api_Module_Dependencies.png)
...
![Com.trekglobal.idempiere.rest.api Run Configuration](pathname:///img/release-notes/v12/Com.trekglobal.idempiere.rest.api_Run_Configuration.png)
