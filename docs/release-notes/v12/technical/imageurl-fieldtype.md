...
**Screens**
![Product image url editor](pathname:///img/release-notes/v12/Product-image-url-editor.png)

_the imageurl editor allow click on field, and enter web url_
![Info window grid withimages](pathname:///img/release-notes/v12/Info-window-grid-withimages.png)
![Info window grid hover](pathname:///img/release-notes/v12/Info-window-grid-hover.png)
