...
![Required Plugin   Required Plugin   Window (iDempiere 1.0.0)](pathname:///img/release-notes/v12/Required_Plugin_-_Required_Plugin_-_Window_(iDempiere_1.0.0).png)

This is how the error in console looks when a plugin is not found:

![01 ServerTerminated](pathname:///img/release-notes/v12/01_ServerTerminated.png)
