...
![ReactivationInvoice DocType CanBeReactivated](pathname:///img/release-notes/v12/ReactivationInvoice_DocType_CanBeReactivated.png)

- **Role must be authorized**
If is ticked and role has been granted to reactive it (via Document Action Access tab):

![ReactivationInvoice Role DocActionAccess](pathname:///img/release-notes/v12/ReactivationInvoice_Role_DocActionAccess.png)

You'll find the Re-activate item on Document Action :

![ReactivationInvoice DocAction](pathname:///img/release-notes/v12/ReactivationInvoice_DocAction.png)
