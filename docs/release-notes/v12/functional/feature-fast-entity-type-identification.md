---
id: feature-fast-entity-type-identification
...
![UserPreference](pathname:///img/release-notes/v12/UserPreference.png)
...
![EntityType Identification Tool tip & How To](pathname:///img/release-notes/v12/EntityType_Identification_Tool_tip_&_How_To.png)
![EntityType HelpWindow](pathname:///img/release-notes/v12/EntityType_HelpWindow.png)

You can see the entity type of a field in the changelog as its current value as well
![EntityType ChangeLog](pathname:///img/release-notes/v12/EntityType_ChangeLog.png)
