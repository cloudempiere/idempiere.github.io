...
![01 SimilarToPreference](pathname:///img/release-notes/v5.1/01_SimilarToPreference.png)

After the user enable that, then syntax similar to regular expression can be used, for example:

![02 UserQuery](pathname:///img/release-notes/v5.1/02_UserQuery.png)

Result in these records:

![03 ResultSimilarTo](pathname:///img/release-notes/v5.1/03_ResultSimilarTo.png)
