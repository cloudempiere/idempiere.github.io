---
id: enable-accounting-configuration-for-time-range
title: "Enable Accounting Configuration For Time Range"
sidebar_label: "Enable Accounting Configuration For Time Range"
...
![Accounting Schema Validity](pathname:///img/release-notes/v13/Accounting_Schema_Validity.png)
...
![Img always update](pathname:///img/release-notes/v13/Img_always_update.png)
...
_Source: [Wiki](https://wiki.idempiere.org/en/NF13_Accounting_Schema_Valid_Range)_
