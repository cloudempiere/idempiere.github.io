---
id: custom-key-of-document-sequence
title: "Custom Key of Document Sequence"
sidebar_label: "Custom Key of Document Sequence"
description: "**System Design:** Norbert Bede, Cloudempiere"
tags: [v13, technical]
---
...
1. Define the Prefix or Suffix of Document Sequence like so: ***@DateOrdered&lt;yy&gt;/K@/@C_BPartner_ID/K@/***
...
![Screenshot 2025 06 12 at 16.26.44](pathname:///img/release-notes/v13/Screenshot_2025-06-12_at_16.26.44.png)

_Example of Document Sequence with Custom key_
...
_Source: [Wiki](https://wiki.idempiere.org/en/NF13_Custom_key_of_document_sequence)_
