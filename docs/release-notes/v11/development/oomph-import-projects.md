...
![Clone iDempiere Source](pathname:///img/release-notes/v11/Clone_iDempiere_Source.gif)

_Clone iDempiere Source_

- Run Maven Build.

![Run Maven build](pathname:///img/release-notes/v11/Run_Maven_build.gif)
