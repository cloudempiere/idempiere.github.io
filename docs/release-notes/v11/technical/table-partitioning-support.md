...
![Table Partitioning AD ChangeLog](pathname:///img/release-notes/v11/Table_Partitioning_AD_ChangeLog.png)

_AD_ChangeLog_
![Table Partitioning AD Session](pathname:///img/release-notes/v11/Table_Partitioning_AD_Session.png)
...
![Table Partitioning AD ChangeLog List](pathname:///img/release-notes/v11/Table_Partitioning_AD_ChangeLog_List.png)

_List Partitioning_
![Table Partitioning AD Session Range](pathname:///img/release-notes/v11/Table_Partitioning_AD_Session_Range.png)
...
![Table Partitioning Process](pathname:///img/release-notes/v11/Table_Partitioning_Process.png)
...
![Table Partitioning Process MenuItem](pathname:///img/release-notes/v11/Table_Partitioning_Process_MenuItem.png)
...
![Table Partitioning Table Partition](pathname:///img/release-notes/v11/Table_Partitioning_Table_Partition.png)
...
![Table Partitioning Scheduler](pathname:///img/release-notes/v11/Table_Partitioning_Scheduler.png)
...
```
![Partition table workflow](pathname:///img/release-notes/v11/Partition_table_workflow.jpg)
