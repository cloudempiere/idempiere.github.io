...
![Doc type group](pathname:///img/release-notes/v11/Doc_type_group.png)
DocType group Implementation in Period Control managent, allow open a doctype group. This open 2 period control
![Doctype Group Period](pathname:///img/release-notes/v11/Doctype_Group_Period.png)
...
![Doctype Group Period Control](pathname:///img/release-notes/v11/Doctype_Group_Period_Control.png)
