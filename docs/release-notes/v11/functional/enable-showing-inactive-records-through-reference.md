---
id: enable-showing-inactive-records-through-reference
...
![ShowInactive](pathname:///img/release-notes/v11/ShowInactive.png)

Note that the list shows the inactive records surrounded by tilde characters (~), like:

![ShowingUOMInactive](pathname:///img/release-notes/v11/ShowingUOMInactive.png)
