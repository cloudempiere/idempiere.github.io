...
![01 VFormat](pathname:///img/release-notes/v11/01_VFormat.png)

This is what the user would see when entering an invalid Name:

![02 Error](pathname:///img/release-notes/v11/02_Error.png)
...
![03 Message](pathname:///img/release-notes/v11/03_Message.png)

And now the user would see the error like:

![04 Error](pathname:///img/release-notes/v11/04_Error.png)
