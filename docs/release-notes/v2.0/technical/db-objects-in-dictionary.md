...
![NF20Index01](pathname:///img/release-notes/v2.0/NF20Index01.png)

The button *Index Validate* creates or recreates the index in the database

![NF20Index02](pathname:///img/release-notes/v2.0/NF20Index02.png)
...
![NF20CreateTableIndex](pathname:///img/release-notes/v2.0/NF20CreateTableIndex.png)
...
![NF20ViewComponents](pathname:///img/release-notes/v2.0/NF20ViewComponents.png)

Once your view is defined/modified you can create/recreate the view using the button *View Validate*

![NF20ViewValidate](pathname:///img/release-notes/v2.0/NF20ViewValidate.png)
...
![NF20Constraint](pathname:///img/release-notes/v2.0/NF20Constraint.png)
