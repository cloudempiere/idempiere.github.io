...
![EstimatedLandedCost Accounting Schema](pathname:///img/release-notes/v2.0/EstimatedLandedCost_Accounting_Schema.png)

Product Category Accounting:
![EstimatedLandedCost Product Category](pathname:///img/release-notes/v2.0/EstimatedLandedCost_Product_Category.png)

Product Accounting:
![EstimatedLandedCost Product](pathname:///img/release-notes/v2.0/EstimatedLandedCost_Product.png)
...
![EstimatedLandedCost Purchase Order](pathname:///img/release-notes/v2.0/EstimatedLandedCost_Purchase_Order.png)
...
![EstimatedLandedCost Material Receipt Posting](pathname:///img/release-notes/v2.0/EstimatedLandedCost_Material_Receipt_Posting.png)

3. Enter landed cost invoice.

![EstimatedLandedCost Landed Cost Invoice Line](pathname:///img/release-notes/v2.0/EstimatedLandedCost_Landed_Cost_Invoice_Line.png)

4. Distribute the landed cost invoice line to Material Receipt

![EstimatedLandedCost Distribute Landed Costs](pathname:///img/release-notes/v2.0/EstimatedLandedCost_Distribute_Landed_Costs.png)

5. Result of #4.

![EstimatedLandedCost Landed Cost Allocation](pathname:///img/release-notes/v2.0/EstimatedLandedCost_Landed_Cost_Allocation.png)
...
![EstimatedLandedCost Landed Cost Posting](pathname:///img/release-notes/v2.0/EstimatedLandedCost_Landed_Cost_Posting.png)

7. The Landed Cost is added to the product cost.

![EstimatedLandedCost Product Cost 1](pathname:///img/release-notes/v2.0/EstimatedLandedCost_Product_Cost_1.png)

![EstimatedLandedCost Product Cost 2](pathname:///img/release-notes/v2.0/EstimatedLandedCost_Product_Cost_2.png)
