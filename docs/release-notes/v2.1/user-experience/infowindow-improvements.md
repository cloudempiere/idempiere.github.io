...
![Infowindow reset](pathname:///img/release-notes/v2.1/Infowindow_reset.png)

***2. Add ability define "Default Logic" value for criteria field***

same default logic field at standard window

![Infowindow defaultValue](pathname:///img/release-notes/v2.1/Infowindow_defaultValue.png)
...
![Infowindow displayLogicProcess](pathname:///img/release-notes/v2.1/Infowindow_displayLogicProcess.png)
