...
![01 SL Message](pathname:///img/release-notes/v2.1/01_SL_Message.png)
...
![02 SL Query Used](pathname:///img/release-notes/v2.1/02_SL_Query_Used.png)

The resulting status line is shown in next screenshot:

![03 SL StatusLine](pathname:///img/release-notes/v2.1/03_SL_StatusLine.png)
