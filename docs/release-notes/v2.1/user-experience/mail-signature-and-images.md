...
![01 MailSignature](pathname:///img/release-notes/v2.1/01_MailSignature.png)
...
![02 MailSignature](pathname:///img/release-notes/v2.1/02_MailSignature.png)

In the mail dialog window you can see the result of enabling this functionality and the new add-signature button:

![03 MailSignature](pathname:///img/release-notes/v2.1/03_MailSignature.png)
