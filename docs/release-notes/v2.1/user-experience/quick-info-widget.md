...
<YouTube id="lLtjxjklfZY" /> by Jan.thielemann - [evenos Consulting GmbH](http://evenos-consulting.de)
...
![01 QI Message](pathname:///img/release-notes/v2.1/01_QI_Message.png)
...
![02 QI Query Used](pathname:///img/release-notes/v2.1/02_QI_Query_Used.png)

- You can define more than one message/query for each window/tab/table:

![03 QI Query2 Used](pathname:///img/release-notes/v2.1/03_QI_Query2_Used.png)
...
![04 QI QuickInfo](pathname:///img/release-notes/v2.1/04_QI_QuickInfo.png)
