---
status: approved
id: run-reports-in-the-scheduler-using-context-variables-for-dates
...
![iDempiere report scheduler with relative parameters](pathname:///img/release-notes/v2.1/iDempiere_report_scheduler_with_relative_parameters.png)
