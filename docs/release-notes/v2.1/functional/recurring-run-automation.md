...
![01 Recurring](pathname:///img/release-notes/v2.1/01_Recurring.png)
...
![02 Recurring](pathname:///img/release-notes/v2.1/02_Recurring.png)

Then you define the recurring to automate and assign it to a group:

![03 Recurring](pathname:///img/release-notes/v2.1/03_Recurring.png)
...
![04 Recurring](pathname:///img/release-notes/v2.1/04_Recurring.png)

And this is the resulting order based on the recurring run of the example:

![05 Recurring](pathname:///img/release-notes/v2.1/05_Recurring.png)
