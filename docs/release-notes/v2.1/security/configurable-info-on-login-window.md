---
status: approved
id: configurable-info-on-login-window
...
![All keys set 1](pathname:///img/release-notes/v2.1/All_keys_set_1.png)

_All keys set in the System Configurator_
![All keys set 2](pathname:///img/release-notes/v2.1/All_keys_set_2.png)

_Version Info panel showing all values. Some are overwritten via System Configurator_
![No keys set in production system](pathname:///img/release-notes/v2.1/No_keys_set_in_production_system.png)
