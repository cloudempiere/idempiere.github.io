---
id: how-to-using-print-format-item-scripts-in-reports
...
```This could be entered as follows:![IDEMPIERE 5011 boolean](pathname:///img/release-notes/v9/IDEMPIERE-5011-boolean.png)
...
```This could be entered as follows and include a Format Pattern to display as a percentage:![IDEMPIERE 5011 previous](pathname:///img/release-notes/v9/IDEMPIERE-5011-previous.png)
