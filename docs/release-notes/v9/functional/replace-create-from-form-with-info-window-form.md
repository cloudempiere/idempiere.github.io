---
id: replace-create-from-form-with-info-window-form
...
:![5396 Column Button InfoWindow](pathname:///img/release-notes/v9/5396_Column_Button_InfoWindow.png)
...
:![5396 InfoWindow Process](pathname:///img/release-notes/v9/5396_InfoWindow_Process.png)

_Info Window Process_

2. Add **Query After Change** field to **Column** tab of **Info Window** window.
:![5396 InfoColumn QueryAfterChange](pathname:///img/release-notes/v9/5396_InfoColumn_QueryAfterChange.png)
...
:![5396 MaterialReceipt](pathname:///img/release-notes/v9/5396_MaterialReceipt.png)
...
:![5396 MaterialReceipt InfoWindow](pathname:///img/release-notes/v9/5396_MaterialReceipt_InfoWindow.png)
