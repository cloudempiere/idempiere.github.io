---
id: osgi-interface-to-create-custom-header-and-footer
...
![4894 Print Header Footer Window](pathname:///img/release-notes/v9/4894_Print_Header_Footer_Window.png)
...
- Example:
![4894 Print Format Example](pathname:///img/release-notes/v9/4894_Print_Format_Example.png)

_Print Format Example Header and Footer_

## Example
### With Standard Header and Footer
![4894 BusinessPartnerDetails StandardHeaderFooter](pathname:///img/release-notes/v9/4894_BusinessPartnerDetails_StandardHeaderFooter.png)

_Business Partner Details with Standard Header and Footer_

### With Example Header and Footer
![4894 BusinessPartnerDetail ExamplePrintHeaderFooter](pathname:///img/release-notes/v9/4894_BusinessPartnerDetail_ExamplePrintHeaderFooter.png)
