---
id: cloud-upload-interface-for-report-viewer-and-scheduler
...
![AddAuthorizationAccount.png](pathname:///img/release-notes/v9/AddAuthorizationAccount.png.png)

After successful authorization, you should have a record added to the Authorization Account:

![AuthorizationCredentialAndAuthorizationAccount](pathname:///img/release-notes/v9/AuthorizationCredentialAndAuthorizationAccount.png)

## Usage
Cloud upload at Report Viewer:

![CloudUploadToolbarButton](pathname:///img/release-notes/v9/CloudUploadToolbarButton.png)

Upload Dialog for Google Drive plugin above:

![UploadToGoogleDrive](pathname:///img/release-notes/v9/UploadToGoogleDrive.png)

Cloud Upload field at Scheduler Recipient (Upload, Authorization Account and File Name):

![SchedulerRecipient](pathname:///img/release-notes/v9/SchedulerRecipient.png)
