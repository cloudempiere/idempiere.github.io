---
id: multiple-bom-support-for-mfg-light
...
1. * ![BOM 1250](pathname:///img/release-notes/v9/BOM_1250.png)

_BOM tab_
1. BOM Formula field at Production window
1. * ![Production BOM Formula 1250](pathname:///img/release-notes/v9/Production_BOM_Formula_1250.png)

_BOM Formula field at Production window_
1. BOM Formula field at Create Production dialog
1. * ![Create Production BOM Formula 1250](pathname:///img/release-notes/v9/Create_Production_BOM_Formula_1250.png)
