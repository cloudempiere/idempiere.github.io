---
status: approved
id: improvement-detail-panel-toolbar
title: "Improvement: Detail Panel ToolBar"
sidebar_label: "Improvement: Detail Panel ToolBar"
description: "**Sponsor:** [Integratio](/docs/sponsors/Integratio)"
tags: [v3.0, user-experience]
---

## **Improvement:** Detail Panel ToolBar
**Goal:** Usability

**Sponsor:** [Integratio](/docs/sponsors/Integratio)
...
![DetailToolbar](pathname:///img/release-notes/v3.0/DetailToolbar.png)
...
![ToolBarButton detail](pathname:///img/release-notes/v3.0/ToolBarButton-detail.png)
...
![DetailToolbarRestriction](pathname:///img/release-notes/v3.0/DetailToolbarRestriction.png)
