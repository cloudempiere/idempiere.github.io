...
![UserPreferencesPopup](pathname:///img/release-notes/v3.0/UserPreferencesPopup.png)

- When you click on the More Preference option, the User Preference's window will be open.

![UserPreferenceWindow](pathname:///img/release-notes/v3.0/UserPreferenceWindow.png)
