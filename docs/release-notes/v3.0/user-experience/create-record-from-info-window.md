---
status: approved
id: create-record-from-info-window
...
The table must be configured to use [Quick Entry](/docs/NF1.0_QuickEntry)

![01 CreateFromInfo](pathname:///img/release-notes/v3.0/01_CreateFromInfo.png)
