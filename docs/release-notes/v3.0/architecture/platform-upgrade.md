...
You can find some hints collected from Hieplq in the page [Update your development environment zk7 branch](/docs/Update_your_development_environment_zk7_branch)
