---
status: approved
id: exclude-locators-for-demand-operations
...
![FS ExcludeLocators Locator](pathname:///img/release-notes/v3.0/FS_ExcludeLocators_Locator.png)

Pointing to a new table/window Locator Type that is user definable:

![FS ExcludeLocators LocatorType](pathname:///img/release-notes/v3.0/FS_ExcludeLocators_LocatorType.png)
