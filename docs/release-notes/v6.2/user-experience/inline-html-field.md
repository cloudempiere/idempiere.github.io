...
![InlineHTMLFieldDefinition](pathname:///img/release-notes/v6.2/InlineHTMLFieldDefinition.png)

This flag is visible just for fields with type String, Text and Text Long.

This is how the field is presented to the user:

![InlineHTMLFieldUsage](pathname:///img/release-notes/v6.2/InlineHTMLFieldUsage.png)
