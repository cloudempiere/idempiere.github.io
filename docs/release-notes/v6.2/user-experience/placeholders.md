...
![PlaceholderDefinitionElement](pathname:///img/release-notes/v6.2/PlaceholderDefinitionElement.png)

For example when entering a new record this is what the user can see:

![PlaceholderExecution](pathname:///img/release-notes/v6.2/PlaceholderExecution.png)
...
![PlaceholderCountryDefinition](pathname:///img/release-notes/v6.2/PlaceholderCountryDefinition.png)

For example when entering a location this is what the user can see:

![PlaceholderCountryExecution](pathname:///img/release-notes/v6.2/PlaceholderCountryExecution.png)
