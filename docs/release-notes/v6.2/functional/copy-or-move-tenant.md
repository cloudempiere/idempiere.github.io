...
![01 MoveTenant](pathname:///img/release-notes/v6.2/01_MoveTenant.png)
...
![Copy Tenant   Process (iDempiere 1.0.0)](pathname:///img/release-notes/v6.2/Copy_Tenant_-_Process_(iDempiere_1.0.0).png)
